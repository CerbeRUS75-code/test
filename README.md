...
Синхронна и асинхронная репликация, довольно всё просто, синхронная реаликация - мы пока что не закомитим транзакцию на реплики, не закомитим ее на мастере
